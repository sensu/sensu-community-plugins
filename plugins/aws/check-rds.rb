...
#     check-procs -i sensu-admin-db --cpu-warning-over 80 --cpu-critical-over 90
#
#     # Critical if CPUUtilization is over 90%, maximum of last one hour
#     check-procs -i sensu-admin-db --cpu-critical-over 90 --statistics maximum --period 3600
#
...
#     check-procs -i sensu-admin-db --memory-warning-over 80 --statistics minimum --period 7200
#
#     # Disk usage, same as memory
#     check-procs -i sensu-admin-db --disk-warning-over 80 --period 7200
#
#     # You can check multiple metrics simultaneously. Highest severity will be reported
#     check-procs -i sensu-admin-db --cpu-warning-over 80 --cpu-critical-over 90 --memory-warning-over 60 --memory-critical-over 80
#
