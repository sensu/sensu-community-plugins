...
class ESMetrics < Sensu::Plugin::Metric::CLI::Graphite
  ...
  def run
    ...
    metrics['indices.filter.size']              = node['indices']['filter_cache']['memory_size_in_bytes']
    metrics['indices.id.size']                  = node['indices']['id_cache']['memory_size_in_bytes']
    metrics['indices.fielddata.size']           = node['indices']['fielddata']['memory_size_in_bytes']
